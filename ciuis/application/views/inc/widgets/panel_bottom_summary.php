<div class="ciuis-an-x">
	<div class="ciuis-panel-summary-bg col-md-3 col-xs-6 text-center blr-5 tlr-5 md-pt-15 md-mr-10">
		...
		<h1 class="txt-scale-xs no-margin-top text-danger xs-28px figures"><span class="money-area" ng-bind="stats.oft"></span></h1>
	...
	<div class="ciuis-panel-summary-bg col-md-3 col-xs-6 text-center brr-5 trr-5 md-pt-15 md-mr-10">
		...
		<h1 class="txt-scale-xs no-margin-top xs-28px figures"><span class="money-area" ng-bind="stats.akt"></span></h1>
		<p class="secondary-text">
			<?php echo lang('lastmonth'); ?><br>
			<strong><span class="money-area" ng-bind="stats.oak"></span></strong>
	...
	<div class="ciuis-panel-summary-bg col-md-3 col-xs-6 text-center rad-5 md-pt-15 pull-right">
		...
		<h1 class="txt-scale-xs no-margin-top xs-28px figures"><span class="money-area" ng-bind="stats.mex"></span></h1>
		<p class="secondary-text">
			<?php echo lang('lastmonth'); ?><br>
			<strong><span class="money-area" ng-bind="stats.pme"></span></strong>
	...
	<div class="ciuis-panel-summary-bg col-md-3 col-xs-6 text-center rad-5 md-pt-15">
		...
		<h1 class="txt-scale-xs no-margin-top xs-28px figures"><span class="money-area" ng-bind="stats.ycr"></span></h1>
		<p class="secondary-text">
			<?php echo lang('lastyear'); ?> <br>
			<strong><span class="money-area" ng-bind="stats.oyc"></span></strong>
