				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-sm-9 add-on-edit">
							...
							<option value="<?php echo $invoices['customer_id'];?>"><?php if($invoices['type']==0) {echo $invoices['customercompany'];} else echo $invoices['individual'];?></option>
								<?php
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div data-min-view="2" data-date-format="dd.mm.yyyy" class="input-group date datetimepicker"> <span class="input-group-addon btn btn-default"><i class="icon-th mdi mdi-calendar"></i></span>
								<input type='input' name="created" value="<?php echo ($this->input->post('created') ? $this->input->post('created') : _udate($invoices['created'])); ?>" class="form-control" id="created"/>
							</div>
						</div>
					</div>
				</div>
					...
					<div id="toggle-invoice-status">
						...
						<div class="col-md-9">
							<div class="btn-group" data-toggle="buttons">
								<label class="btn btn-lg btn-default btn-reverse <?php if($invoices['status_id'] == 3){echo'active';}?>">
								<input name="status" type="radio" autocomplete="off" <?php if($invoices['status_id'] == 3){echo'checked';}?> value="3">
								<?php echo lang('willbepaid'); ?></label>
											<label class="btn btn-lg btn-default btn-reverse <?php if($invoices['status_id'] == 2){echo'active';}?>">
								<input name="status" type="radio" autocomplete="off" <?php if($invoices['status_id'] == 2){echo'checked';}?> value="2">
								<?php echo lang('paid'); ?></label>
								<label class="btn btn-lg btn-default btn-reverse <?php if($invoices['status_id'] == 1){echo'active';}?>">
								<input name="status" type="radio"  autocomplete="off" <?php if($invoices['status_id'] == 1){echo'checked';}?>  value="1">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a data-invoice='<?php echo $invoices['id']?>' ng-click='InvoiceCancel($event)'><?php echo lang('cancelled')?></a></li>
							</ul>
						</div>
						</div>
					</div>
						<div id="toggle-kasa-bilgileri">
							<div class="form-group toggle-cash" style="<?php if($invoices['status_id'] == 2){echo'display:interit';}else echo 'display:none'?>">
								...
								<div class="col-md-9">
									...
									<div class="icon"><span class="mdi <?php if($invoices['status_id'] == 2){echo 'mdi-check';}else echo 'ion-alert';?>"></span></div>
									<div class="message" style="display: inherit">
										<strong><?php if($invoices['status_id'] == 2){echo lang('thisinvoicehasbeenpaid');}else echo lang('recordpaymentfirst');?></strong>
									</div>
								  	</div>
								</div>
							</div>
							<div class="form-group toggle-due" style="<?php if($invoices['status_id'] == 3){echo'display:interit';}else echo 'display:none'?>">
						...
						<div class="form-group cancelledinvoicealert" style="<?php if($invoices['status_id'] == 4){echo'display:interit';}else echo 'display:none'?>">
								<label for="vade" class="col-md-3 control-label control-label-sm"></label>
								<div class="col-md-9">
