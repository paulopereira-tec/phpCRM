			...
			<div class="ciuis-389123411">
				<div class="ciuis98765789 fadeIn">
					<div class="ciuis9876578d">
						...
						<h4 class="text-bold money-area"><b><?php $this->db->select_sum('amount')->from('payments')->where('(account_id = '.$accounts['id'].' and transactiontype = 0)'); 
							$mbb = $this->db->get(); 
							if ($mbb->row()->amount>0){
								echo $mbb->row()->amount;
							}else{ 
						...
						<p>
							<b><?php echo lang('accountstatus'); ?>: <?php switch ( $accounts[ 'status_id' ] ) {case '0':echo '<span class="text-success">'.lang( 'active' ).'</span>';break;case '1':	echo '<span class="text-danger">'.lang( 'inactive' ).'</span>';break;}?></b>
						</p>
						<div class="bar">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<div class="switch-button switch-button-success pull-left">
						<input type="checkbox" <?= $accounts['status_id'] == 1 ? 'checked value="1"' : 'value="1"' ?> name="status" id="swt6"><span>
