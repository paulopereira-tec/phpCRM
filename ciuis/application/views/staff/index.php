          ...
          <div class="col-md-4">
            <div class="user-display">
              ...
              <div class="user-display-bottom">
                <div class="user-display-avatar"><img src="<?php echo base_url(); ?>uploads/images/<?php if($t['staffavatar'] != NULL){echo $t['staffavatar'];}else {echo 'n-img.jpg';}; ?>" alt="Avatar"></div>
