			...
			<div class="row">
				<div class="col-md-5">
					<div class="user-display">
						<div class="user-display-bg"><img src="<?php echo base_url(); ?>assets/img/staffmember_bg.png" alt="<?php echo $staff['staffname']; ?>">
						</div>
						<div class="user-display-bottom" >
							<div class="user-display-avatar"><img src="<?php echo base_url(); ?>uploads/images/<?php echo $staff['staffavatar']; ?>" alt="<?php echo $staff['staffname']; ?>">
							</div>
				...
				<div class="col-md-7">
					<div class="user-info-list panel panel-default borderten">
						...
						<a ng-hide="ONLYADMIN != 'true'" href="<?php echo base_url('staff/edit/'.$staff['id'].'') ?>" class="btn btn-default btn-lg pull-right"><?php echo lang('edit') ?></a>
