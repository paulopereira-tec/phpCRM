              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group "><span class="input-group-addon"><i class="mdi mdi-phone"></i></span>
                    <input name="phone" type="text" value="<?php echo ($this->input->post('phone') ? $this->input->post('phone') : $staff['phone']); ?>" placeholder="+1 (555) 555 5555" class="form-control">
                  </div>
                </div>
                <div class="form-group">
              ...
              <div class="col-md-12">
                <div class="form-group">
					...
					<select required name="department" class="form-control select2">
						<option value="<?php echo $staff['department_id']; ?>">Active : <?php echo $staff['department']; ?></option>
						<?php
						foreach ( $departments as $department ) {
							$selected = ( $department[ 'id' ] == $this->input->post( 'department' ) ) ? ' selected="selected"' : null;
				...
				if ( $staff[ 'staffavatar' ] == NULL || $staff[ 'staffavatar' ] === 'n-img.jpg' ) {
					...
					<div class="input-group">
						<span class="input-group-addon"><img class="img-rounded xs-mr-10" height="25px" src="' . base_url( 'uploads/images/' ), $staff[ 'staffavatar' ] . '" alt=""></span>
