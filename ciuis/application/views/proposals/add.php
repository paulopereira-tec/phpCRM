...
<div class="ciuis-body-content" ng-controller="Proposals_Controller">
	<?php echo form_open('proposals/add',array("class"=>"form-horizontal main-content container-fluid col-xs-12 col-md-12 col-lg-9")); ?>
		...
		<div class="panel-body" style="padding:30px 20px;">
			...
			<div class="form-group md-p-0">
				<div class="col-sm-4">
					<div class="btn-group pull-right">
						...
						<button type="submit" class="btn btn-space btn-default btn-lg">
							<?php echo lang('save'); ?>
						</button>
					</div>
				</div>
				...
				<div class="col-md-12 md-m-0 md-p-0">
					<div class="form-group">
						<div class="col-md-6 md-pl-0">
							...
							<select  name="assigned" class="select2">
								<?php
			...
			<div class="col-md-6 md-pl-30">
				...
				<div class="form-group has-warning">
					...
					<div data-min-view="2" data-date-format="dd.mm.yyyy" class="input-group date datetimepicker"> <span class="input-group-addon btn btn-default"><i class="icon-th mdi mdi-calendar"></i></span>
						<input placeholder="<?php echo date(" d.m.Y "); ?>" required type='input' name="opentill" value="<?php echo $this->input->post('opentill'); ?>" class="form-control" id="opentill"/>
					</div>
				</div>
