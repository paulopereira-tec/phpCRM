				...
				<div class="proposal panel borderten" style="padding-top: 20px;padding-right: 0px;">
					<main>
						<div id="details" class="clearfix">
							...
							<?php if($proposals['status_id'] == 1){echo '<span class="label label-default p-s-lab p-s-v pull-left">'.lang('draft').'</span>';}  ?>
							<?php if($proposals['status_id'] == 2){echo '<span class="label label-default p-s-lab p-s-v pull-left">'.lang('sent').'</span>';}  ?>
							<?php if($proposals['status_id'] == 3){echo '<span class="label label-default p-s-lab p-s-v pull-left">'.lang('open').'</span>';}  ?>
							<?php if($proposals['status_id'] == 4){echo '<span class="label label-default p-s-lab p-s-v pull-left">'.lang('revised').'</span>';}  ?>
							<?php if($proposals['status_id'] == 5){echo '<span class="label label-default p-s-lab p-s-v pull-left">'.lang('declined').'</span>';}  ?>
							<?php if($proposals['status_id'] == 6){echo '<span class="label label-default p-s-lab p-s-v pull-left">'.lang('accepted').'</span>';}  ?>
							</div>
