				...
				<div class="form-group">
					...
					<div class="col-sm-9 add-on-edit">
						<select  name="customer" class="form-control select2">
							...
							<option value="<?php echo $proposals['relation'];?>"><?php if($proposals['relation_type']==0) {echo $proposals['customercompany'];} else echo $proposals['individual'];?></option>
				...
				<div id="toggle-invoice-status">
					...
					<div id="toggle-account-info">
						<div class="form-group toggle-cash" style="display:none;">
							...
							<div class="col-md-9">
								<select required name="account" class="form-control select2">
						...
						<div class="form-group toggle-payment" style="display:none;">
							...
							<div class="col-md-9">
								<div class=" input-group-icon">
									<div data-min-view="2" data-date-format="dd.mm.yyyy" class="input-group date datetimepicker"> <span class="input-group-addon btn btn-default"><i class="icon-th mdi mdi-calendar"></i></span>
							<input required placeholder="<?php echo date(" d.m.Y "); ?>" type='input' name="datepayment" value="<?php echo $this->input->post('datepayment'); ?>" class="form-control" id="datepayment"/>
						</div>
								</div>
							</div>
						</div>
