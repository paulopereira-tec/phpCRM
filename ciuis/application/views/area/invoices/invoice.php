			...
			<div class="btn-group btn-space pull-right md-mt-20 md-mr-20 <?php if($settings['paypalenable'] != 1){echo 'hide';} ?>"> <button type="button" class="btn btn-color btn-social btn-dropbox"><i class="icon mdi mdi-paypal-alt"></i></button> <a href="<?php echo site_url('pay/invoice/'.$invoices['id']); ?>" type="button" class="btn btn-default"><?php echo lang('paynow'); ?></a></div>
				<div class="invoice">
					...
					<div class="row invoice-data">
						...
						<div class="col-xs-5 invoice-person">
							<span class="name"><?php if($invoices['customer_id']===NULL){echo $invoices['namesurname'];} else echo $invoices['customercompany']; ?></span>
				...
				<div class="col-md-12">
					...
					<div class="row invoice-footer">
						<div class="col-md-12">
							<a href="<?php echo base_url('area/invoice_pdf/'.$invoices['id'].'');?>" class="btn btn-lg btn-space btn-default"><?php echo lang('savepdf')?></a>
							<a href="<?php echo base_url('area/invoice_pdf/'.$invoices['id'].'?print=true');?>" class="btn btn-lg btn-space btn-default"><?php echo lang('print')?></a>
						</div>
					</div>
				</div>
			</div>
