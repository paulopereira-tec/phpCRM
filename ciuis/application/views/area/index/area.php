...
{echo '<div class="col-md-12 text-center"><p><img src="'.base_url('assets/img/afternoon.png').'" alt=""></p><p><h4>'.lang('goodafternoon').'</h4><span>'.$this->session->userdata('staffname').'</span></p></div>';} else if ( $time >= "17" && $time < "19" ) 
{echo '<div class="col-md-12 text-center"><p><img src="'.base_url('assets/img/evening.png').'" alt=""></p><p><h4>'.lang('goodevening').'</h4><span>'.$this->session->userdata('staffname').'</span></p></div>';} else if ( $time >= "19" ) 
