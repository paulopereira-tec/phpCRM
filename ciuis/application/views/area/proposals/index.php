...
<div class="ciuis-body-content" ng-controller="Proposals_Controller">
	<div class="main-content container-fluid col-xs-12 col-md-9 col-lg-9 md-p-10">
		<div style="border-radius: 10px;" class="panel-default">
			...
			<ul class="custom-ciuis-list-body" style="padding: 0px;">
				<li ng-repeat="proposal in proposals | filter: { relation_type: 'customer'} | filter: {relation: '<?php echo $_SESSION[ 'customer' ] ?>'} | filter:search | pagination : currentPage*itemsPerPage | limitTo: 5" class="ciuis-custom-list-item ciuis-special-list-item lead-name">
					<ul class="list-item-for-custom-list">
						...
						<div class="assigned-staff-for-this-lead user-avatar"><i class="ico-ciuis-proposals" style="font-size: 32px"></i></div>
							...
							<a href="<?php echo base_url('share/proposal/'); ?>{{proposal.id}}"><strong ng-bind="proposal.subject"></strong></a><br>
							...
							<div class="col-md-9">
								...
								<div class="col-md-1">
								<div style="margin-top: 5px;" data-toggle="tooltip" data-placement="left" data-container="body" title="" data-original-title="Created by: {{proposal.staff}}" class="assigned-staff-for-this-lead user-avatar"><img src="<?php echo base_url('uploads/images/{{proposal.staffavatar}}')?>" alt="{{proposal.staff}}">
										</div>
								</div>
							</div>
						</li>
