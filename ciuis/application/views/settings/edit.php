				...
				<div class="panel panel-default rad-5">
					...
					<div class="tab-container">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#companysettings" data-toggle="tab"><strong><?php echo lang('companysettings')?></strong></a></li>
							<li><a href="#financialsettings" data-toggle="tab"><strong><?php echo lang('financialsettings')?></strong></a></li>
							<li><a href="#localization" data-toggle="tab"><strong><?php echo lang('localization')?></strong></a></li>
							<li><a href="#emailsettings" data-toggle="tab"><strong><?php echo lang('emailsettings')?></strong></a></li>
							<li><a href="#customization" data-toggle="tab"><strong><?php echo lang('customization')?></strong></a></li>
							<li><a href="#paymentgateway" data-toggle="tab"><strong><?php echo lang('paymentgateway')?></strong></a></li>
						</ul>
						<div class="tab-content">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label for="company" class="control-label xs-mb-0"><?php echo lang('company')?> </label>
											<p class="xs-mb-5"><?php echo lang('whyrequired')?> <a href="javascript:;" data-toggle="popover" data-trigger="hover" title="<?php echo lang('information')?>" data-content="<?php echo lang('companysub')?> " data-placement="top"><b> ?</b></a></p>
										...
										<div class="form-group">
											<label for="email" class="control-label xs-mb-0"><?php echo lang('email')?> </label>
											<p class="xs-mb-5"><?php echo lang('whyrequired')?> <a href="javascript:;" data-toggle="popover" data-trigger="hover" title="<?php echo lang('information')?>" data-content="<?php echo lang('emailsub')?> " data-placement="top"><b> ?</b></a></p>
										...
										<div class="form-group">
											...
											<select required name="country_id" class="form-control select2">
												<option value="<?php echo $settings['country_id']; ?>"><?php echo lang('active')?>  : <?php echo $settings['country']; ?></option>
												<?php
												foreach ( $countries as $country ) {
													$selected = ( $country[ 'id' ] == $this->input->post( 'country_id' ) ) ? ' selected="selected"' : null;
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											<label for="zipcode" class="control-label xs-mb-0"><?php echo lang('zipcode')?> </label>
											<p class="xs-mb-5"><?php echo lang('whyrequired')?> <a href="javascript:;" data-toggle="popover" data-trigger="hover" title="<?php echo lang('information')?>" data-content="<?php echo lang('zipcodesub')?> " data-placement="top"><b> ?</b></a></p>
											<input type="text" name="zipcode" value="<?php echo ($this->input->post('zipcode') ? $this->input->post('zipcode') : $settings['zipcode']); ?>" class="form-control" id="zipcode"/>
										</div>
										<div class="form-group">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<option value="<?php echo $settings['unitseparator']?>">
												...
												case ',': echo 'Active : '.lang('comma').'';break; 
												case '.': echo 'Active : '.lang('dot').'';break; 
												}?>
											</option>
										...
										<div class="form-group">
											...
											<option value="<?php echo $settings['currencyposition']?>">
												<?php switch($settings['currencyposition']){ 
													case 'before': echo lang('active'),':',lang('beforeamount');break; 
													case 'after': echo lang('active'),':',lang('afteramount');break; 
												}?>
											</option>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select required name="dateformat" class="form-control select2">
												...
												case 'yy.mm.dd': echo 'Active - Y.M.D';break; 
												case 'dd.mm.yy': echo 'Active - D.M.Y';break; 
												case 'yy-mm-dd': echo 'Active - Y-M-D';break; 
												case 'dd-mm-yy': echo 'Active - D-M-Y';break; 
												case 'yy/mm/dd': echo 'Active - Y/M/D';break; 
												case 'dd/mm/yy': echo 'Active - D/M/Y';break; 
							...
							<div id="customization" class="tab-pane cont">
								<div class="row">
									<div class="col-md-6">
										<?php
											...
											echo '<div class="form-group">
												  ...
												  <div class="file-upload">
													<div class="file-select">
													  <div class="file-select-button" id="fileName"><span class="mdi mdi-accounts-list-alt"></span> Logo</div>
										...
										<div class="col-md-12 md-p-0">
											...
											<div class="switch-button switch-button-success">
												<input disabled type="checkbox" <?= $settings['pushState'] == 1 ? 'checked value="1"' : 'value="1"' ?> name="pushState" id="swt6"><span>
							...
							<div id="paymentgateway" class="tab-pane cont">
								<div class="row">
									<div class="col-md-6">
									<div class="form-group">
