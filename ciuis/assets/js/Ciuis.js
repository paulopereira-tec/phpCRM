...
var App = (function () {
	...
	App.dataTables = function () {
		...
		$.extend(true, $.fn.dataTable.defaults, {
			dom: "<'row ciuis-body-datatable-header'<'col-sm-6'l><'col-sm-6'f>>" +
	...
	function beInactive() {
	$('.vertical-nav-new-ciuis .slide.two').removeClass('active').addClass('inactive');
	$('.vertical-nav-new-ciuis .slide.one').addClass('active').removeClass('inactive');
}

$(".navigation").hover(beInactive); 

$(".vertical-nav-new-ciuis.hover").hoverIntent({
  over: beWide, 
  out: beNarrow,
  timeout: 600
});
