...
--
-- Host: localhost:8889
-- Generation Time: Dec 02, 2017 at 02:28 AM
...
INSERT INTO `currencies` (`id`, `symbol`, `name`, `default`) VALUES
(1, '$', 'USD', 0),
(2, '€', 'EUR', 0),
(3, '₽', 'RUB', 0),
(4, '₺', 'TRY', 0),
...
CREATE TABLE `invoiceitems` (
  `id` int(11) NOT NULL,
  `in[itemid]` int(11) DEFAULT NULL,
  `in[name]` varchar(255) NOT NULL,
  `in[code]` varchar(255) NOT NULL,
  `invoice_id` int(11) DEFAULT NULL,
  `in[product_id]` int(11) DEFAULT NULL,
  `in[description]` mediumtext,
  `in[amount]` decimal(11,2) DEFAULT NULL,
  `in[unit]` varchar(255) DEFAULT NULL,
  `in[price]` decimal(11,2) DEFAULT NULL,
  `in[price_discounted]` decimal(11,2) DEFAULT NULL,
  `in[discount_rate]` decimal(11,2) DEFAULT NULL,
  `in[discount_type]` varchar(255) DEFAULT NULL,
  `in[discount_rate_status]` int(11) DEFAULT NULL,
  `in[vat]` decimal(11,2) DEFAULT NULL,
  `in[total_vat]` decimal(11,2) DEFAULT NULL,
  `in[total]` decimal(11,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `invoices` (
  ...
  `total_sub` decimal(11,2) DEFAULT NULL,
  `total_discount` decimal(11,2) DEFAULT NULL,
  `sub_discount` decimal(11,2) DEFAULT NULL,
  `sub_discount_type` int(11) DEFAULT NULL,
  `total_sub_discount` decimal(11,2) DEFAULT NULL,
  `sub_discount_status` int(11) DEFAULT NULL,
  `total_vat` decimal(11,2) DEFAULT NULL,
...
(1, '<a href=\"staff/staffmember/1\"> Lance Bogrol</a> logged in the system', '2017-12-02 03:19:41', '1', NULL, 0),
(2, '<a href=\"staff/staffmember/1\"> Lance Bogrol</a> deleted Staff-2', '2017-12-02 03:21:00', '1', NULL, 0),
(3, '<a href=\"staff/staffmember/1\"> Lance Bogrol</a> deleted Staff-4', '2017-12-02 03:21:05', '1', NULL, 0),
(4, '<a href=\"staff/staffmember/1\"> Lance Bogrol</a> deleted Staff-3', '2017-12-02 03:21:12', '1', NULL, 0),
(5, 'Lance Bogrol changed Lance Bogrol\'s login password.', '2017-12-02 03:21:34', '1', NULL, 0);
...
(1, 1, 'PANEL', NULL, 0, NULL, 'index.php', 0),
(2, 2, 'FINANCE', NULL, 0, NULL, NULL, 0),
(3, 3, 'CUSTOMERS & LEADS', NULL, 0, NULL, NULL, 0),
(4, 4, 'TRACK', NULL, 0, NULL, NULL, 0),
(5, 5, 'OTHERS', NULL, 0, NULL, NULL, 1),
(6, 6, 'CALENDAR', NULL, 0, NULL, 'calendar/', 0),
(7, 1, 'Invoices', 'Manage Invoices', 2, 'ico-ciuis-invoices', 'invoices/', 0),
(8, 2, 'Proposals', 'Manage Proposals', 2, 'ico-ciuis-proposals', 'proposals/', 0),
(9, 2, 'Expenses', 'Manage Expenses', 2, 'ico-ciuis-expenses', 'expenses/', 0),
(10, 2, 'Accounts', 'Manage Accounts', 2, 'ico-ciuis-accounts', 'accounts/', 1),
(11, 1, 'Customers', 'Manage Customers', 3, 'ico-ciuis-customers', 'customers/', 0),
(12, 2, 'Leads', 'Manage Leads', 3, 'ico-ciuis-leads', 'leads/', 0),
(13, 1, 'Projects', 'Manage Projects', 4, 'ico-ciuis-projects', 'projects/', 0),
(14, 2, 'Tasks', 'Manage Tasks', 4, 'ico-ciuis-tasks', 'tasks/', 0),
(15, 3, 'Tickets', 'Manage Tickets', 4, 'ico-ciuis-supports', 'tickets/', 0),
(16, 4, 'Products', 'Manage Products', 4, 'ico-ciuis-products', 'products/', 0),
(17, 1, 'Staff', 'Manage Staff', 5, 'ico-ciuis-staff', 'staff/', 1),
(18, 2, 'Reports', 'Manage Reports', 5, 'ico-ciuis-reports', 'report/', 1);
...
('500d532bf0f5c3e321808528fcef51ce559c6af7', '::1', 1512177722, );
...
(1, 1, 'english', 'Administrator', 'pm.jpg', 1, '+1-202-555-0160', '71 Pilgrim Avenue Chevy Chase, MD 20815', 'root@ciuis.com', '1992-12-05', '63a9f0ea7bb98050796b649e85481845', NULL, 1, NULL, '2017-08-05 03:02:42', NULL);
...
--
-- Indexes for table `proposalitems`
--
ALTER TABLE `proposalitems`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `projects`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `proposalitems`
--
ALTER TABLE `proposalitems`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
